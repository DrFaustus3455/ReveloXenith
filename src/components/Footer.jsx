...
const FOOTER_LINKS = {
  ...
  Work: [
    ...
    { label: 'Animation', to: '/services' },
    { label: '3D Art', to: '/services' },
    { label: 'Illustrations', to: '/services' },
  ],
};

// Replace these platform URLs with Revelo Xenith's profile URLs when available.
const SOCIAL_LINKS = [
  { Icon: Instagram, label: 'Instagram', href: 'https://www.instagram.com/reveloxenith?stkn=eDJlZGV2czA3OGYz' },
  { Icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/company/revelo-xenith/' },
  { Icon: Facebook, label: 'Facebook', href: 'https://www.facebook.com/share/1BTU1gaKRo/' },
];
